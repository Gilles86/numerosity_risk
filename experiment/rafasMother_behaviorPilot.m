function rafasMother_behaviorPilot(subCode, nameSub, inputTrials1, inputTrials2)
%%% For the behavioral experiment...
%%% Magnitude Comparison, n = 150
...
% 
% exp_RiskComp_behaviorPilot(subCode, nameSub, expType, riskExpStim, inputTrials1, windowmode, screenResolution, bg, openFolder, subFolder, taskSequence, taskSeqNum)
...
for blockSeq = 1:2
    if sequence(blockSeq) == 1
        ...
        exp_RiskComp_behaviorPilot(subCode, nameSub, expType, riskExpStim, inputTrials2, windowmode, screenResolution, bg, openFolder, subFolder, taskSequence, taskSeqNum)
