function gen_dotMagRisk_basic(subCode, nameSub, expType, inputTrials, startStim, numRoot, maxStim, rngMin, rngMax, rngSpc, probability)
...
magRiskTrial.breakPeriods          = -2.*ones(nTrials, 1);
...
if expType == 1
    if subCode < 10
        save(['subject_0' num2str(subCode) '_' nameSub '_genParadigm_0'  num2str(expType) '_magComp' '.mat'],'magRiskTrial');
    elseif subCode >= 10
        save(['subject_' num2str(subCode) '_' nameSub '_genParadigm_0'  num2str(expType) '_magComp' '.mat'],'magRiskTrial');
    end
elseif expType == 2
    if subCode < 10
        save(['subject_0' num2str(subCode) '_' nameSub '_genParadigm_0'  num2str(expType) '_riskComp' '.mat'],'magRiskTrial');
    elseif subCode >= 10
        save(['subject_' num2str(subCode) '_' nameSub '_genParadigm_0'  num2str(expType) '_riskComp' '.mat'],'magRiskTrial');
    end
end
