function gen_dotMagRisk_behaviorPilot(subCode, run, nameSub, expType, inputTrials, startStim, numRoot, maxStim, rngMin, rngMax, rngSpc, probability, openFolder, subFolder)
