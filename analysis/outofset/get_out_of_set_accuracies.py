...
neural_results = neural_results.set_index(['type', 'subject', 'mask']).loc['trialwise']

behav = pd.read_csv(op.join(bids_folder, 'derivatives', 'summary_data', 'subjectwise_data.csv')).set_index('subject')
    ...
    for x, y in product(xs, ys):
        ...
        try: 
            ...
            if (not op.exists(target_file_accuracy)) or overwrite:
                ...
                null = get_null(d, x, y, n=100, n_jobs=7)
